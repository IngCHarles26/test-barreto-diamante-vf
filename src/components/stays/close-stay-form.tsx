...
export const CloseStayForm = ({stayId,pays,room}:Props) => {
  ...
  return (
    <>
      <div className='w-full'>
        <button 
          className='ml-auto flex items-center gap-2 text-white bg-danger rounded-xl text-xl px-4 py-2 font-bold'
          onClick={handleOpen}
        >
          Terminar
