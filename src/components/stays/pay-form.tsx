...
import { ActiveStay, useMessageStore, useStayStore } from '@/store'
...
export const PayForm = ({ currentData }:Props) => {
  ...
  return (
    <>
      <button popoverTarget={dialogId} className="bg-primary text-white px-3 md:px-4 rounded-xl font-bold text-base md:text-xl flex items-center gap-1 py-2">
