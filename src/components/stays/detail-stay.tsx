...
import { genVisualDate, penFormat, transformDate } from '@/lib/shared'
        ...
        <DialogContent maxWRem={35}>
          ...
          <div className='px-3 mt-2'>
            <div className='mb-1 flex items-center text-sm'>
              ...
              <a 
                href={'https://docs.google.com/forms/d/e/1FAIpQLSewo8BIitKUW4x_e6cEu-Vvk0VvlzQm-sLTivOVU-AXeKNI5Q/viewform?usp=pp_url&entry.576917304='+images} 
                target='_blank' 
